...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const stopBtn = document.querySelector('.slider-stop');
    ...
    document.querySelectorAll('.slide-content .add-to-cart').forEach(button => {
        button.addEventListener('click', function() {
            const name = this.getAttribute('data-name');
            const price = parseInt(this.getAttribute('data-price'));
    ...
    if (sliderContainer) {
        ...
        progressBar.innerHTML = '<div class="slider-progress-bar active"></div>';
