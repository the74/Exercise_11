...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const mainImageDesc = document.getElementById('mainImageDesc');
    ...
    function showImage(index) {
        ...
        mainImageDesc.textContent = desc;

        // Обновляем кнопку добавления в корзину
        const addToCartBtn = document.querySelector('.main-image .add-to-cart');
        if (addToCartBtn) {
            addToCartBtn.dataset.name = name;
            addToCartBtn.dataset.price = price;
            addToCartBtn.textContent = `Добавить в корзину - ${price} ₽`;
        }
    ...
    // Обновляем обработчик кнопки добавления в корзину в галерее
    const galleryAddToCartBtn = document.querySelector('.main-image .add-to-cart');
    if (galleryAddToCartBtn) {
        galleryAddToCartBtn.addEventListener('click', function() {
